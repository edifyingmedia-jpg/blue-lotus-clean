...
import { ArrowRight, Leaf, Sprout, Trees, Crown, Zap, Activity, Loader2 } from 'lucide-react';
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 2rem' }}>
        <div style={{ width: '100%', maxWidth: '800px', textAlign: 'center', transform: 'translateY(-12%)' }}>
          ...
          <div style={{ 
            ...
            border: '1px solid rgba(79, 70, 229, 0.2)', borderRadius: '20px', padding: '1.25rem',
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '0.25rem' }}>
              <button 
                onClick={handleForgeBuild}
                disabled={isBuilding}
                style={{ 
                  background: isBuilding ? '#6B7280' : 'linear-gradient(135deg, #4F46E5, #3730A3)', 
                  color: 'white', border: 'none', padding: '0.6rem 2.2rem', borderRadius: '8px', 

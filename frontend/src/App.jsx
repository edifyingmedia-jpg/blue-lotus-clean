...
function App() {
  ...
  const handleCommand = (e) => {
    ...
    const newLogs = [...consoleLog, `> ${input}`];
    setConsoleLog(newLogs);
    setInput("");

    // Simulate TWIN Response
    setTimeout(() => {
      setConsoleLog(prev => [...prev, "// TWIN: Command acknowledged. Processing neural request..."]);
    }, 600);
  };
    ...
    <div style={{ backgroundColor: '#010204', color: '#fff', height: '100vh', display: 'flex', flexDirection: 'column', fontFamily: 'monospace', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={{ width: '400px', borderRight: '1px solid rgba(56, 189, 248, 0.1)', display: 'flex', flexDirection: 'column', backgroundColor: '#000' }}>
          ...
          {/* Input Area */}
          <form onSubmit={handleCommand} style={{ padding: '20px', borderTop: '1px solid rgba(56, 189, 248, 0.1)' }}>
